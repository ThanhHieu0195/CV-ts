...
export const MockUserData: IUser = {
  ...
  position: "",
  avt: "https://f3.photo.talk.zdn.vn/3218624441194484522/af2f582594c2589c01d3.jpg",
  basicInfos: [
    {
    ...
    // },
    {
      text: "Huynh Tan Phat Street, District 7, Ho Chi Minh City",
  ...
  metaInfos: [
    {
      heading: "EDUCATION",
      infos: ["License - College of Foreign Economy and Relations"],
    },
    {
      heading: "SKILLS",
      infos: [
      ...
      detail: [
        {
          ...
          data: [
            ...
            },
            {
              ...
              content: [
                "Perform daily senior tasks: absence report, give solution for agents, support Management on manage (performance, KPI, ...), report on daily-weekly-monthly ...",
                "Work closely with Management to handle technical problems, marketing campaign issues, cases threat to brand image, receive feedback from agents and consult with Management to adjust the process",
                "Training knowledge for new agents, 1: 1 private communication with agent as needed, monitoring KPIs for team (approximate 15 members), keep spirit and high connection among team members...",
                "Direct handling of bad rating (rated 1 * and 2 *) after call / mail",
                "Balance between senior performance and individual performance (ensure volume as well as quality of support as a call center agent)",
